...
import { TrendingUp, Shield, Target, ChevronRight, ChevronLeft, Check, Loader2 } from 'lucide-react';
import { SiGoogle } from 'react-icons/si';
import type { ExperienceLevel, TradingGoal, RiskTolerance } from '@shared/schema';

type OnboardingStep = 'LOGIN' | 'SURVEY_1' | 'SURVEY_2' | 'SURVEY_3' | 'COMPLETE';
...
export function Onboarding() {
  ...
  const handleComplete = () => {
    completeOnboarding(experience, goal, risk);
    setStep('COMPLETE');
  };
  ...
  const getProgress = () => {
    switch (step) {
      case 'LOGIN': return 0;
      case 'SURVEY_1': return 33;
      case 'SURVEY_2': return 66;
